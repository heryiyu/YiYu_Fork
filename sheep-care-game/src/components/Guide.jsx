    ...
    return (
        ...
        <div className="debug-editor-overlay" onClick={onClose}>
            <div
                ...
                style={{
                    width: activeTab === 'MANUAL' ? '100%' : '500px',
                    maxWidth: activeTab === 'MANUAL' ? '1000px' : '90vw',
            ...
            >
                ...
                <div style={{ maxHeight: '70vh', overflowY: 'auto', fontSize: '0.9rem', lineHeight: '1.5', color: '#000', padding: '0 5px' }}>
                    {activeTab === 'MANUAL' ? (
                        ...
                        <>
                            ...
                            <h4>4. 靈程與資料管理</h4>
                            <p>
                                <strong>靈程 (Maturity):</strong> 可設定小羊的屬靈階段 (新朋友/慕道友/基督徒...)。<br />
                                <strong>使用說明:</strong> 請使用 LINE 帳號登入，系統會自動備份您的羊群資料。
                            </p>

                            <h4>5. 提醒與通知 (Bell)</h4>
                            <p>
                                <strong>鈴鐺按鈕 (右上方):</strong> 點擊鈴鐺可開啟/關閉牧羊提醒。<br />
                                <strong>開啟後:</strong> 系統將在適當時間提醒您回來關心羊群的狀況。
                            </p>
